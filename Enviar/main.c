...
// Struct para armazenar informações dos artistashehe.
typedef struct {
    char nome[100];
    char genero[100];
    char local[100];
...
// Struct para armazenar uma lista de artistas
typedef struct {
    Artista *artistas;
    int num_artistas;
} ListaArtistas;

// Função/método para ler os registros do arquivo e criar a lista de artistas
